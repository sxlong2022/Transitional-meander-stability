...
from src.stability.solve_os import solve_os
from src.stability.os_operator_curved import solve_os_curved
...
def load_field_params(csv_path: Path) -> dict:
    """ hydraulic_params_timeseries.csv  2011-2021 。"""
    import csv as _csv
    rows = []
