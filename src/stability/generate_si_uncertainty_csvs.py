...
def generate_table_s5_spectral_sensitivity() -> pd.DataFrame:
    ...
    df_s6 = pd.DataFrame([
        ...
        {"test_type": "Resampling step ds", "configuration": "ds = 200 m", "L_corr_C_m": 265.0, "lambda_B_km": 16.4, "lambda_C_km": 9.3, "rel_diff": "< +-4%"},
        {"test_type": "Smoothing window W", "configuration": "W = 300 m (3 ds)", "L_corr_C_m": 210.0, "lambda_B_km": 16.2, "lambda_C_km": 8.9, "rel_diff": "-6.2%"},
        {"test_type": "Smoothing window W", "configuration": "W = 500 m (5 ds)", "L_corr_C_m": 230.0, "lambda_B_km": 16.2, "lambda_C_km": 9.1, "rel_diff": "-2.1%"},
        {"test_type": "Smoothing window W", "configuration": "W = 1000 m (10 ds, Baseline)", "L_corr_C_m": 240.0, "lambda_B_km": 16.2, "lambda_C_km": 9.2, "rel_diff": "Baseline"},
        {"test_type": "Smoothing window W", "configuration": "W = 1500 m (15 ds)", "L_corr_C_m": 275.0, "lambda_B_km": 16.3, "lambda_C_km": 9.4, "rel_diff": "+4.5%"},
        ...
        {"test_type": "Discharge-induced width perturbation", "configuration": "Wet-width contraction (-25%)", "L_corr_C_m": np.nan, "lambda_B_km": 16.2, "lambda_C_km": np.nan, "rel_diff": "0.0%"},
        {"test_type": "Discharge-induced width perturbation", "configuration": "Wet-width expansion (+25%)", "L_corr_C_m": np.nan, "lambda_B_km": 16.2, "lambda_C_km": np.nan, "rel_diff": "0.0%"},
