...
Output  : results/spectral/spectral_summary.csv          — 24 
...
def dominant_wavelength(x: np.ndarray, step_m: float,
    ...
    return {
        "lambda_m": lam,
        "freq": f_peak,
        "amp": float(amp_no_dc[peak_idx]),  # Returns，
